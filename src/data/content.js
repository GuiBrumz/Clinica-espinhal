...
export const DOCTOR = {
  ...
  bio: [
    ...
    'Cada paciente recebe um plano terapêutico individualizado, construído com base em diagnóstico preciso e avaliação criteriosa de cada caso. O acompanhamento próximo desde a consulta inicial até o pós-operatório é o compromisso central da clínica.',
  ],
  education: [],
  certifications: [
...
export const TREATMENTS = [
  ...
  },
  {
    ...
    icon: 'scan',
    image: 'https://images.unsplash.com/photo-1516549655169-df83a0774514?w=700&h=500&fit=crop',
