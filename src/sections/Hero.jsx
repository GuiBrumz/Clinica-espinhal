    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(150deg, rgba(15,23,42,0.82) 0%, rgba(30,58,138,0.72) 50%, rgba(29,78,216,0.60) 100%)' }}
        />
      </div>
      ...
      {FLOATING_CARDS.map((card) => (
        ...
        >
          <div className="w-8 h-8 rounded-xl bg-white/15 border border-white/20 flex items-center justify-center shrink-0">
            <card.Icon size={15} className="text-blue-200" />
          </div>
          <div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.h1
              variants={fadeUp}
              className="font-heading text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.08] mb-6 tracking-[-0.03em]"
            >
              Referência em{' '}
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="group relative flex items-center justify-center gap-3 px-8 py-4 bg-white text-brand-700 font-bold rounded-2xl text-base shadow-xl transition-all duration-300"
              >
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 glass rounded-2xl p-4 w-48 shadow-xl"
            >
              <div className="flex items-center gap-2 mb-1">
                <Award size={14} className="text-blue-200 shrink-0" />
            ...
            >
              ...
              <div className="text-blue-200 text-xs">atendidos</div>
            </motion.div>
          </motion.div>
        </div>
      </div>
