...
import { Star, Quote, ChevronLeft, ChevronRight, TrendingUp, Users, CheckCircle } from 'lucide-react'
  ...
  return (
    <section id="depoimentos" className="py-24 lg:py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-neutral-900 mt-4 mb-3">
              Pacientes que <span className="text-gradient-blue">recuperaram</span>
              <br className="hidden md:block" /> suas vidas
            </h2>
            <p className="text-neutral-500 max-w-lg">
              Mais de 5.000 pacientes tratados. Cada história é um testemunho de dedicação, técnica e cuidado.
            </p>
          </div>
          ...
          >
            <div className="flex -ml-6">
              {TESTIMONIALS.map((t) => (
                <div
                  key={t.id}
                  className="flex-none min-w-0 w-full pl-6 sm:w-1/2 lg:w-1/3"
                >
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-neutral-100">
                      <div className="relative">
                        <img
                          ...
                          loading="lazy"
                          onError={(e) => {
                            e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(t.name)}&background=0057FF&color=fff&size=80`
                          }}
                        />
        ...
        >
          {[
            { value: '4.98/5', label: 'Nota no Google',    Icon: TrendingUp  },
            { value: '5.000+', label: 'Pacientes tratados', Icon: Users       },
            { value: '98%',    label: 'Taxa de satisfação', Icon: CheckCircle },
          ].map((item, i) => (
