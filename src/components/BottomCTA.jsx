        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3.5 justify-center">
            <a
              ...
              className="group inline-flex items-center justify-center gap-2.5 px-8 py-4 bg-white text-neutral-950 font-semibold rounded-xl text-sm transition-[background-color,transform] duration-200 hover:bg-neutral-100 hover:-translate-y-px shadow-[0_8px_24px_rgba(0,0,0,0.3)]"
            >
